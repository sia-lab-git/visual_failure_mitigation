from xpc3 import *
from xpc3_helper_PAEI import *
from xpc3_helper_SK_PAEI import *
from nnet import *
...
def get_simulator_and_model(start_params, classifier_weights):
    ...
    client.sendDREF("sim/time/zulu_time_sec", TIME_OF_DAY*3600+9*3600) # Adding 9 to convert to UTC, specific to runway location 
...
def rollout(client, network, num_steps=500, dt=0.05, ctrl_every=1, sim_dynamics='dubins', ideal=0, image_getter = getCurrentImage, classifier=None, use_fallback=False):
    ...
    for i in range(num_steps):
        ...
        if abs(cte) > 16.0:              # Safety limit different for reach runway
